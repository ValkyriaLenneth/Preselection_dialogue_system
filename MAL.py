...
class Encoder(nn.Module):
    def __init__(self, src_vocab_size, embedding_size, hidden_size):
        ...
        self.b_embedding = self.c_embedding # use the same embedding layer
    ...
    def forward(self, data):
        self.c_enc.flatten_parameters()
        self.b_enc.flatten_parameters()
        self.matching_gru.flatten_parameters()
...
class Mixture(nn.Module):
    ...
    def forward(self, state,  selector_action, generator_action, b_map):
        ...
        generator_action = F.softmax(generator_action, dim=1) # p_vocab
